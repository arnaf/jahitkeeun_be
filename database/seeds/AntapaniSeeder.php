...
class AntapaniSeeder extends Seeder
{
    /**
    ...
    public function run()
    {
        ...
        for($i = 0; $i < 5; $i++) {
            ...
            $superadmin2 = User::create([
                'name' => $faker->name,
                'email'=> 'clientantapani'.''.$faker->unique()->numberBetween(1,5).''.'@gmail.com',
            ...
            $id = Client::insertGetId([
                ...
                'photo' => 'avatar.png',
                'phone' => $faker->unique()->numberBetween(6282111200300,6282111200305),
            ...
            $id=$faker->randomElement((['3273141001','3273141002','3273141003','3273141004']));
        ...
        for($i = 0; $i < 5; $i++) {
            $superadmin3 = User::create([
                ...
                'email'=> 'taylorantapani'.''.$faker->unique()->numberBetween(6,10).''.'@gmail.com',
                'password' => bcrypt('password'),
                'status' => '1',
                'created_at' => date('Y-m-d H:i:s')
            ]);
            ...
            $id = Taylor::insertGetId([
                ...
                'photo' => 'avatar.png',
                'phone' => $faker->unique()->numberBetween(6282111300111,6282111300115),
                'dateBirth' => date('1997-01-01 H:i:s'),
                'placeBirth' => 'Bandung',
                'rating' => rand(0, 5),
                'status' => '1',
        ...
        for($i = 0; $i < 5; $i++) {
            $superadmin4 = User::create([
                'name' => $faker->name,
                'email'=> 'convectionantapani'.''.$faker->unique()->numberBetween(11,15).''.'@gmail.com',
                'password' => bcrypt('password'),
                'status' => '1',
                'created_at' => date('Y-m-d H:i:s')
            ]);
            ...
            $id = Convection::insertGetId([
                ...
                'photo' => 'avatar.png',
                'phone' => $faker->unique()->numberBetween(6282111400131,6282111400141),
                'dateBirth' => date('1997-01-01 H:i:s'),
                'placeBirth' => 'Bandung',
                'status' => '1',
                'created_at'    => date('Y-m-d H:i:s')
